...
import com.example.myapplication.ui.theme.BlueJC
import com.example.myapplication.ui.theme.DarkBlueJC
...
fun WeatherScreen() {
    ...
    val apiKey = "5594e076710f06ee0c3820628b4b61e0"

    Box(
        modifier = Modifier
            .fillMaxSize()
            .paint(
                painterResource(id = R.drawable.weatheimg),
